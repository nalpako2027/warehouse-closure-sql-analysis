...
View the live interactive dashboard: **[Click Here](https://warehouse-closure-sql-analysisgit.streamlit.app/)**  or Visit https://warehouse-closure-sql-analysisgit.streamlit.app/
...
Alternatively, for a more business-oriented view of the results, explore the interactive dashboard with the link above — a preview of the Final Recommendation view is shown below.
